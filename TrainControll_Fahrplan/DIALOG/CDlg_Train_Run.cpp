...
BOOL CDlg_Run_Train::OnInitDialog()
{
	...
	if (m_nID == CDlg_Run_Train::IDD)  { SetWindowPos(NULL,  10, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD1) { SetWindowPos(NULL, 410, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD2) { SetWindowPos(NULL, 810, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD3) { SetWindowPos(NULL, 1210, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD4) { SetWindowPos(NULL, 1610, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD5) { SetWindowPos(NULL, 2010, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD6) { SetWindowPos(NULL, 2410, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD7) { SetWindowPos(NULL, 2810, 1450, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); }
	if (m_nID == CDlg_Run_Train::IDD8)
	{
		SetWindowPos(NULL, 3210, 14500, -1, -1, SWP_NOSIZE | SWP_NOZORDER | SWP_NOACTIVATE); 
		Lok_Bild = NULL;
	...
	else
	{
		...
		Lok_Pfeil_vor = (HBITMAP)::LoadBitmap(::AfxGetInstanceHandle(), MAKEINTRESOURCE(IDB_PFEIL_R));
		Lok_Pfeil_zur = (HBITMAP)::LoadBitmap(::AfxGetInstanceHandle(), MAKEINTRESOURCE(IDB_PFEIL_L));
	}
